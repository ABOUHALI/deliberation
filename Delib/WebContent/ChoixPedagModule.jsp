...
<body>
	...
	<div class="edit" style="margin-left: 300px; margin-bottom: 300px;">
		<form action="choix-listModule.do" method="post">
			...
			<div class="form-row">
				...
				<select class="form-select" aria-label="Disabled select example" name="module" >
          ...
          <div class="section-header">
            <h1>Liste des inscriptions pédagogiques</h1>
          </div>
