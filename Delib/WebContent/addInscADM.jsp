...
<div class="form-row">
					...
					<div class="position-relative form-group">
						<label for="Nom Etudiant" class="">Telephone</label> <input
							id="Nom Etudiant" type="text" name="tel" />
...
<div class="form-check">
  ...
  <label class="form-check-label" for="flexRadioDefault2">
   NON
		...
		<div class="col-md-6">
			<div class="position-relative form-group">
				<label for="Filiere" class="">Filiere</label> <select name="filiere"
					id="Filiere" class="form-control" required>
			...
			<div class="col-md-6">
				<div class="position-relative form-group">
					<input type="checkbox" class="form-check-input"
						...
						style="margin-left: 1px"> <label style="margin-left: 15px">Photo</label>


					<input type="checkbox" class="form-check-input"
						onchange="displayInput('cne')" name="filtre"
						style="margin-left: 1px"> <label style="margin-left: 15px">CNE</label>


					<input type="checkbox" class="form-check-input"
						onchange="displayInput('bac')" name="filtre"
						style="margin-left: 10px"> <label
						style="margin-left: 28px">Bac</label> <input type="checkbox"
						class="form-check-input" onchange="displayInput('rn')"
						name="filtre" style="margin-left: 10px"> <label
						style="margin-left: 28px">Relevé de note</label> <input
						type="checkbox" class="form-check-input"
						onchange="displayInput('an')" name="filtre"
						style="margin-left: 10px"> <label
						style="margin-left: 28px">Acte de Naissance</label> <input
						type="checkbox" class="form-check-input"
						onchange="displayInput('cin')" name="filtre"
						style="margin-left: 10px"> <label
						style="margin-left: 28px">Cin</label><br>
				</div>
			</div>
