								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div class="all-form-element-inner">
										<form action="ajouter-professeur.php" method=post>
											...
											<div class="sparkline12-graph">
				                                <div id="pwd-container1">
				                                    <div class="form-group">
													 ...
													 <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
				                                        <input  name="mdp" type="text" class="form-control example1" id="password1" placeholder="Password">
														...
														<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
															<div class="form-select-list">
																<select class="form-control custom-select-value"
																	name="module">
																	<option ></option>
																	 <c:forEach items="${modules}" var="e" varStatus="loop"> 
																<option> 
                                        									${ e.getLabelleMod()}</option>
																			</c:forEach>
																</select>
															</div>
														</div>
															...
															<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
																<div class="form-select-list">
																	<select class="form-control custom-select-value"
																		name="element">
																		<option ></option>
																		<c:forEach items="${Leselements}" var="e" varStatus="loop"> 
																		<option>  
                                        									${ e.getLabelleElement()}</option>
																			</c:forEach>
											...
											<button type="submit" class="btn btn-custon-rounded-three btn-success"> Ajouter le professeur</button>
										</form>
									</div>
								</div>
							</div>
