				...
				<tbody>
					<tr>
						...
						<c:forEach items="${module}" var="m">
							<tr>
								<td><c:out value="${m.getIDModule()}" /></td>
								<td><c:out value="${ m.getLabelleMod()}" /></td>
								<td><c:out value="${ m.getCoeff()}" /></td>
								<td><a href="ajouter-element?id=<c:out  value='${ m.getNbr_elt()}'/>&idm=<c:out  value='${ m.getIDModule()}'/>"><c:out value="${ m.getNbr_elt()}" /></a></td>
								<td><c:out value="${ m.getNote_valid()}" /></td>
