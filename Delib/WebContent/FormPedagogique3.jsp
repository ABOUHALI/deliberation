			...
			<div class="container mt-5">
				<div class="row">
					...
					<div class="login-brand">Inscription Pédagogique</div>
						<form action="pedagogique4.do" method="post">
							<div class="card card-primary">
								<div class="row">
									...
									<div class="col-20 col-md-20 col-lg-5 p-0">
											...
											<div class="form-group">
												<label>Module</label><br> <input type="text" name="module"
													class="form-control"
													value="${module}"
													readonly="readonly">
											</div>
											<div class="form-group">
													<label>Elements</label><br> <select name="element"
														...
														<option></option>
														<c:forEach items="${elements}" var="e" varStatus="loop">
											...
											<div class="form-group text-right">
												<button type="submit"
													class="btn btn-round btn-lg btn-primary">Inscrire Pedagogiquement</button>
											</div>
										</div>
									</div>
								</div>
