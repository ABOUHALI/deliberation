			...
			<table class="table table-striped table-hover">
				<thead>
					<tr>
						...
						<th>Description Etablissement</th>
						<th>Actions</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						...
						<c:forEach items="${etablissement}" var="etab">
							<tr>
								<td><c:out value="${ etab.getIDEtablissement()}" /></td>
								<td><c:out value="${ etab.getEtablissement()}" /></td>
			...
			<div class="modal-content">
				<form action="Ajout.do" method="post">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label>Description_etab</label>
							<textarea class="form-control" name="desc_etab" required></textarea>
						</div>
